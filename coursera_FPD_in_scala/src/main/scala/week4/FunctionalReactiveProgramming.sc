...
object FunctionalReactiveProgramming {
  ...
  def consolidated(accts: List[BankAccountFRP]): Signal[Int] =
	...
	val a = new BankAccountFRP()              //> a  : week4.BankAccountFRP = week4.BankAccountFRP@2f7a2457
	val b = new BankAccountFRP()              //> b  : week4.BankAccountFRP = week4.BankAccountFRP@566776ad
